...
var KonamiCode = {
	cheatsOn: false,
	onComplete: function() {
		$("body").append("<div class='kc-cheats'>CHEATS <span class='kc-cheats-on'>ON</span></div>");
	},
	onFailed: function() { },
	onKeyPressed: function(keyCode) {
		$("body").append(`<div class='kc-key-popup'><div class='kc-key-popup-inner'>${_keyFromCode(keyCode)}</div></div>`);
	}
}
